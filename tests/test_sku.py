"""Tests for ``core.sku`` — SKU parsing and resolution."""
...
from azure_jobs.core.az_client.arm import InstanceTypeInfo, VCInfo
from azure_jobs.core.errors import SkuResolveError
from azure_jobs.core.submit.native.azureml.sku import (
    SkuSpec,
    match_instance_type,
)
...
class TestRowToInfo:
    def test_parses_scratch_storage(self):
        from azure_jobs.core.az_client.arm.instance_types import _row_to_info
...
def _vc(name="vc", series=("Eadsv5", "NDAMv4", "NDv4")):
    from azure_jobs.core.az_client.arm import SeriesQuota, SlaTierQuota
