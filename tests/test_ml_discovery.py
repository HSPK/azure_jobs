...
from azure_jobs.server.az_client import WorkspaceInfo, fetch_jobs_all_workspaces
...
@patch("azure_jobs.server.az_client.AzureMLClient")
@patch("azure_jobs.server.az_client.AzureARMClient")
