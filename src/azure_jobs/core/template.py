"""Amlt template dataclasses + YAML loader.

Defines the dataclass layout for an amlt-style template and the
``read_conf`` / ``merge_confs`` loader that resolves a template's
``base`` inheritance chain into a single dict before construction.
"""
...
# ────────────────────────────────────────────────────────────────────────
# YAML loader + base-chain resolution
# ────────────────────────────────────────────────────────────────────────
