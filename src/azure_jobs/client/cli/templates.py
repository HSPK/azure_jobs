...
from azure_jobs.shared.config import get_defaults, read_config
from azure_jobs.client.ui import console, info, show_template_table, success, warning
...
def template_init(name: str | None, force: bool) -> None:
    ...
    from azure_jobs.client.cli._template_init import run_wizard
...
def template_push(message: str | None) -> None:
    ...
    from azure_jobs.client.cli.pull import _do_push
...
def template_show(name: str) -> None:
    ...
    from azure_jobs.shared.template import ConfigError, read_conf
...
def template_validate(name: str | None) -> None:
    ...
    from azure_jobs.client.ui import emit_json, get_output_mode
    from azure_jobs.client.ui import error as ui_error
