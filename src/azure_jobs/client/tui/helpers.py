...
from azure_jobs.shared.utils.text import trunc as _trunc
from azure_jobs.client.ui import icon_style
...
def info_block(job: Job | Mapping[str, Any]) -> str:
    ...
    from azure_jobs.client.ui import build_job_info_lines, short_portal_url
